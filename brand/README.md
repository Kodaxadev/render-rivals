...
![Arena purple and orange](concepts/01-arena-purple-orange.webp)
...
![Evidence editorial](concepts/02-evidence-editorial.webp)

A calmer analytical direction centered on comparison, evidence breakdowns, and editorial presentation.

### 03 — Premium champion

![Premium champion exploration](concepts/03-premium-champion.webp)
...
![Minimal R monogram](concepts/05-minimal-r-monogram.webp)

A simpler monogram exploration that begins moving away from arena imagery.

### 06 — Twin slash lime

![Twin slash lime](concepts/06-twin-slash-lime.webp)
